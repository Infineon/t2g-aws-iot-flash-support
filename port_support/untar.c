...
/*********************************************************************************************************************/
/**********************************************************************************************************************
 * Function Name: cy_untar_block_of_zeros
 * Parameters:
 *  uint8_t *buffer
 *  uint32_t size
 * Return:
...
/**********************************************************************************************************************
 * Function Name: cy_octal_string_to_u32
 * Parameters:
...
/**********************************************************************************************************************
 * Function Name: ota_untar_json_callback
 * Parameters:
...
/**********************************************************************************************************************
 * Function Name: cy_parse_component_json_data
 * Parameters:
 *  cy_untar_context_t *ctxt
 *  uint8_t *buffer
 *  uint32_t size
 * Return:
 *  cy_untar_result_t
...
/**********************************************************************************************************************
 * Function Name: cy_untar_parse_process_header
 * Summary:
 *  process a ustar header
 * NOTE:
 *  always consumes TAR_BLOCK_SIZE bytes
 * Parameters:
 *  ctxt[in,out]      ptr to context structure, gets updated
 *  stream_offset[in] offset into entire stream
 *  buffer[in]        ptr to the next buffer of input
 *  size[in]          bytes in tar_buffer
 * Return:
 *  cy_untar_result_t
 *    CY_UNTAR_SUCCESS
 *    CY_UNTAR_ERROR
...
/**********************************************************************************************************************
 * Function Name: cy_untar_parse_process_data
 * Summary:
 *  process tar file data
 * NOTE:
 *  always consumes size bytes
 * Parameters:
 *  ctxt[in,out]      ptr to context structure, gets updated
 *  stream_offset[in] offset into entire stream
 *  buffer[in]        ptr to the next buffer of input
 *  size[in]          bytes in tar_buffer
 *  consumed[out]     ptr to save bytes used in callbacks (or skipped at end of file)
 * Return:
 *  cy_untar_result_t
 *    CY_UNTAR_SUCCESS
 *    CY_UNTAR_ERROR
...
/**********************************************************************************************************************
 * Function Name: cy_is_tar_header
 * Summary:
 *  Determine if this is a tar header
 * Parameters:
 *  buffer[in]        ptr to data buffer
...
/**********************************************************************************************************************
 * Function Name: cy_untar_init
 * Summary:
 *  Initialize our tar context
 * Parameters:
 *  ctxt[in,out]      ptr to context structure
...
/**********************************************************************************************************************
 * Function Name: cy_untar_deinit
 * Summary:
 *  De-Initialize our tar context
 * Parameters:
 *  ctxt[in,out]      ptr to context structure
 * Return:
 *  cy_untar_result_t
...
/**********************************************************************************************************************
 * Function Name: cy_untar_parse
 * Summary:
 *  Parse the tar data
 * NOTE:
 *  This is meant to be called for each chunk of data received
 *  callback will be invoked when there is data to write
 * Parameters:
 *  ctxt[in,out]      ptr to context structure, gets updated
 *  stream_offset[in] offset into entire stream
 *  tar_buffer[in]    ptr to the next buffer of input
 *  size[in]          bytes in tar_buffer
 *  consumed[out]     ptr to save bytes used in callbacks (or skipped at end of file)
 * Return:
 *  cy_untar_result_t
